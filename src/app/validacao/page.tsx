            ...
            <div className="flex bg-zinc-100 dark:bg-slate-800 p-1 rounded-xl border border-zinc-200 dark:border-slate-700 gap-1 items-center font-semibold text-xs">
              ...
              {userRole !== 'viewer' && (
                <button
                  ...
                  className="px-3 py-2 rounded-xl text-zinc-650 dark:text-slate-350 hover:text-zinc-900 dark:hover:text-white hover:bg-white dark:hover:bg-slate-700 hover:shadow-2xs transition-all flex items-center gap-1.5"
                >
                  <span className="text-sm">📥</span>
