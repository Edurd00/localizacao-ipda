...
import {
  ...
  BarChart3, CheckSquare, Sparkles, TrendingUp, Upload
} from 'lucide-react';
import {
      ...
      if (json.success) {
        const dataPayload = json.data || {
          ...
          itens_por_categoria: (json.categorias || []).map((c: any) => ({
            ...
            quantidade: c.total || c.quantidade,
          })),
          itens_por_conservacao: (json.conservacao || []).map((c: any) => ({
