    ...
    <div className="min-h-screen bg-slate-50/50 flex flex-col font-sans">
      ...
      <header className="relative z-[9999] h-16 bg-white/80 border-b border-zinc-200 sticky top-0 shadow-xs flex items-center px-4 md:px-8 justify-between backdrop-blur-md">
        ...
        <div className="flex items-center gap-2">
          ...
          <a href="/" className="px-3 py-1.5 rounded-lg text-zinc-650 hover:text-zinc-900 hover:bg-zinc-200/50 text-xs font-semibold transition-all">🗺️ Mapa Geral</a>
          <a href="/validacao" className="px-3 py-1.5 rounded-lg text-zinc-650 hover:text-zinc-900 hover:bg-zinc-200/50 text-xs font-semibold transition-all">📍 Validação</a>
